...
const Footer = () => {
  return (
    <>
      <footer class="w-100 pt-5  flex-shrink-0 custom__footer">
        <div class="container pt-4 ">
          <div class="row gy-4 gx-5 pb-4">
            <div class="col-lg-3 col-md-12 mt-0 ">
              <div class="row">
                <div class="col-lg-12 col-md-6">
                  <a href="/">
                    <svg
                      ...
                      viewBox="0 0 96 24"
                      role="img"
                      aria-labelledby="aqc4airnvnnfgq5826gif55t0rluvu8u"
                      class="icon dribbble-wordmark"
                    >
                      <path
                        fill-rule="evenodd"
                        clip-rule="evenodd"
            ...
            <div class="col-lg-9 col-md-12 mt-0 ">
              <div class="row  footer_nav">
                <div class="col-md-2  col-sm-6 ">
                  <h5 class="footer_nav_heading m-0">For designers</h5>
                  <ul class="list-unstyled text-muted">
                    <li>
                      <a class="link" href="/pro">
                        Go Pro!
                      </a>
                    </li>
                    <li>
                      <a class="link" href="/shots">
                        Explore design work
                      </a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a class="link" href="/overtime">
                        Overtime podcast
                      </a>
                    </li>
                    <li>
                      <a class="link" href="/shots?list=playoffs">
                        Playoffs
                      </a>
                    </li>
                    <li>
                      <a
                        class="link"
                        href="/shots/20497085-Design-a-colorful-homepage-for-a-new-art-supplies-shop"
                      >
                        Weekly Warm-Up
                      </a>
                    </li>
                    <li>
                      <a
                        target="_blank"
                        class="link"
                        href="https://referral.dribbble.com/"
                        rel="noreferrer"
                      >
                        Refer a Friend
                      </a>
                    ...
                    <li>
                      <a class="link" href="/guidelines">
                        Code of conduct
                      </a>
                    </li>
                  </ul>
                </div>
                <div class="col-md-2 navbar_items col-sm-6">
                  <h5 class="footer_nav_heading mb-3">Hire designers</h5>
                  <ul class="list-unstyled text-muted">
                    <li>
                      <a class="link" href="/jobs/new">
                        Post a job opening
                      </a>
                    </li>
                    <li>
                      <a class="link" href="/freelance-jobs">
                        Post a freelance project
                      </a>
                    </li>
                    <li>
                      <a class="link" href="/designers">
                        Search for designers
                      </a>
                    </li>
                  </ul>
                  <ul class="list-unstyled text-muted">
                    <h5 class="footer_nav_heading mb-3">Brands</h5>
                    <li>
                      <a class="link" href="/advertise">
                        Advertise with us
                      </a>
                    </li>
                  </ul>
                ...
                <div class="col-md-2 navbar_items col-sm-6">
                  <h5 class="footer_nav_heading mb-3">Company</h5>
                  <ul class="list-unstyled text-muted">
                    <li>
                    ...
                    <li>
                      <a class="link" href="/media-kit">
                        Media kit
                      </a>
                    </li>
                    <li>
                      <a class="link" href="/testimonials">
                        Testimonials
                      </a>
                    </li>
                    <li>
                      <a class="link" href="https://developer.dribbble.com">
                        API
                      </a>
                    </li>
                    <li>
                ...
                <div class="col-md-2 navbar_items  col-sm-6">
                  <h5 class="footer_nav_heading mb-3">Directories</h5>
                  <ul class="list-unstyled text-muted">
                    <li>
                      <a class="link" href="/directories/jobs">
                        Design jobs
                      </a>
                    </li>
                    <li>
                      <a class="link" href="/directories/designers">
                        Designers for hire
                      </a>
                    </li>
                    <li>
                      <a class="link" href="/directories/freelance-designers">
                    ...
                    <li>
                      <a class="link" href="/places">
                        Places
                      </a>
                    </li>
                  </ul>
                  <ul class="list-unstyled text-muted">
                    <h5 class="footer_nav_heading mb-3">Design assets</h5>
                    <li>
                      <a class="link" href="/marketplace">
                    ...
                    <li>
                      <a
                        ...
                        class="link"
                        href="https://creativemarket.com/?utm_source=dribbble&amp;utm_medium=referral&amp;utm_campaign=footer"
                      >
                        Creative Market
                      </a>
                    </li>
                    <li>
                      <a
                        ...
                        rel="noopener noreferrer"
                        class="link"
                        href="https://www.fontspring.com/?utm_source=dribbble&amp;utm_medium=referral&amp;utm_campaign=footer"
                      >
                        Fontspring
                      </a>
                    </li>
                    <li>
                      <a
                        ...
                        rel="noopener noreferrer"
                        class="link"
                        href="https://www.fontsquirrel.com/?utm_source=dribbble&amp;utm_medium=referral&amp;utm_campaign=footer"
                      >
                        Font Squirrel
                      </a>
                    </li>
                ...
                <div class="col-md-2 navbar_items col-sm-6">
                  <h5 class="footer_nav_heading mb-3">Design Resources</h5>
                  <ul class="list-unstyled text-muted">
                    <li>
                      <a
                        rel="noopener"
                        class="link"
                        href="/resources/freelance"
                      >
                        Freelancing
                      </a>
                    </li>
                    ...
                    <li>
                      <a
                        rel="noopener"
                        class="link"
                        href="/resources/design-portfolio"
                      >
                        Design Portfolio
                      </a>
                    </li>
                    ...
                    <li>
                      <a
                        rel="noopener"
                        class="link"
                        href="/resources/creative-process"
                      >
                        Creative Process
                      </a>
                    </li>
                    <li>
                      <a
                        rel="noopener"
                        class="link"
                        href="https://www.industry-trends.dribbble.com"
                      >
          ...
          <div class="footer-lower-content">
            ...
            <div class="total-shots-container">
              <div>
                <span class="shots-count">20,555,852</span>
                shots dribbbled
              </div>
              <img
                class="dribbble-ball ls-is-cached lazyloaded"
